---
title: Fire TV Apps Install - 추천 어플 설치법 (Android)
author: FlyingDeuk
...
Fire TV APP STORE는 기본적으로 신용카드 정보와 카드 명세서롤 받는 Billing Address를 요구한다. (배송지 주소가 아니라 청구서 주소가 중요하다.) <br>
...
>Settings에 들어가서 한국어로 변경 <br>

![fire](/img/living/fire/you3.jpg)
>기분 나쁘다. 한국어는 제일 밑에 있다...
...
동일 공유기로 연결하는 방식이 아니라 YOUTUBE ID로 연결하니 어느 호텔이든 모두 사용이 가능하다.
