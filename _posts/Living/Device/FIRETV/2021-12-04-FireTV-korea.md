---
title: Fire TV Stick for Korea - 파이어티비 국내(한국) 사용자를 위한 Fire TV 한방 설정법 (Feat. Netflix, YOUTUBE, Internet, Downloader, KODI, 한국 OTT 서비스) <2023.12.20 Updated>
author: FlyingDeuk
...
기능별로 10불정도의 간격으로 가격이 다르다. 빠른 인터넷 속도를 자랑하는 국내에서 사용을 위해서는 4K 지원하는 버전이 추천된다.
...
- Wavve : 실시간 TV(지상파)는 무료로 시청이 가능하다. 유료화됨 (2022.3)
...
**`단, 볼륨조절 기능이 있는 헤드셋이여야 볼륨조절이 가능하다!!! -> 최근에 출시된 리모컨 볼룸버튼이 있는 경우는 블루투스 연결시 헤드셋의 볼륨을 조절해준다.`**
