---
title: KODI - 최고의 무료 Media Center 어플 (for Mac, Android, Windows, RaspberryPi) <2024.8.15 Updated>
author: FlyingDeuk
...
`Update : KODI Scrubs V2 설치법 추가, KODI 18 -> 19 Python의 버전 변화로 아래와 같은 내용이 있으나 현재는 버전 호환에는 무리가 없는 듯함.`
...
---------
## KODI 18.x 버전 Addons 설치 
=> 18.x 버전이 꼭 필요하지 않는다면 최신 버전의 KODI를 바로 설치하면됨. 아래 포스팅 참조
...
# KODI 19.x 이후 모든 버전 
KODI 19이후는 애드온간의 호환에 문제가 없다. 
18.x 버전의 에드온을 살리고 싶으면 아래 방법을 사용하면 됨. <br>
...
## KODI 19.x~21.x 버전 Addons 설치
- 19.x 이후는 언어의 변화가 없어 모두 호환이 가능하다.  
...
> 상기의 내용은 서비스 종료 또는 유료화로 아래 대체 에드온을 설치하면 됨.

- ### [KODI Scrubs V2 Addons Install & Setup - TheCrew 대체 애드온 Scrubs V2 설치 및 사용법 (Feat. Scrubs V2, a4kSubtitles, SUBDL, Opensubtitles)](/posts/KODI-scrubs/)
  - TheCrew의 대체 애드온 (2024.8)
...
- ### [KODI Netflix Addon 인증키로 로그인하는 법 By 아이폰 (Feat. FireTV, KODI, Neflix, NFAuthenticationKey)](/posts/KODI-netflixkey/) 
  - 아이폰 방법 

- ### [KODI Netflix Addon 인증키로 로그인하는 법 By 안드로이드폰 (Feat. FireTV, KODI, Neflix, NFAuthenticationKey)](/posts/KODI-netflixkey1/) 
  - 안드로이드폰 방법 

- ### [Xiaomi Mi TV Stick KODI Netflix Addon MSL Error - 샤오미 미스틱 코디 넷플릭스 에드온 MSL 에러 해결방법 (Feat. MSL Error, ESN)](/posts/mslerror/)
  - 샤오미 기기 MSL Error 해결 방법
