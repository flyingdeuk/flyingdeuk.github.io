---
title: "References for FlyingDeuk Blog"
subtitle: "post를 위한 참조 페이지"
layout: post
author: "deuk"
header-style: text
tags:
...
* 별이나 대쉬를 앞에 쓰면 ul 리스트 기능을 함

* _기울어진 문자_ : 언더바로 감싼다.

* category : 부제목 밑에 dash 길이만큼 넣어준다.

* 파일 링크 제목은 대괄호로 묶고 괄호로 주소를 붙인다.





를 In the last episode we talked about the data representation of integer, a kind
