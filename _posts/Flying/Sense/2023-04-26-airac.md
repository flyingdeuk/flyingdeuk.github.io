...
# 실제 경험 사례
위에서 언급한 것과 같은 일을 다시 경험하게 되어 실사례를 공유한다. 

![airac](/img/flying/sense/hndairac4.jpg)
- 일본 HND 공항 새벽 출발편이다. 역시나 Enroute는 18 APR 기준으로 써 있고 일본 비행이라 RJ로 검색을 하면 변경이 적용되는 공항이 표시된다. 

> FMS도 역시 Enroute와 같이 18 APR로 되어 있다. 

![airac](/img/flying/sense/hndairac5.jpg)
- Chart는 이미 알고 있는 것과 같이 17APR 1500Z에 변경이 된다. 

> 출발시간이 17APR 1700Z (새벽2시) 출발이다. FMS NAV DATA 변경후 변경사항을 검토한다. 

![airac](/img/flying/sense/hndairac1.jpg)
![airac](/img/flying/sense/hndairac2.jpg)
- Y56 항로상에 2개의 FIX가 추가되었다. 

`해당 내용을 정확하게 알아야하는 이유이다. 새벽에 SATCOM으로 Dispatcher와 통화후 변경된 FLT PLAN으로 적용했다.`
