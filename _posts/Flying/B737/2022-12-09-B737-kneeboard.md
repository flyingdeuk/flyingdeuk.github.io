---
title: B737 빠른 참조를 위한 KNEEBORARD & 원본 파일 공유 <2025.3.23 Updated 마지막 업데이트>
date: 2023-04-26
...
## `기종 전환으로 B737의 업데이트는 이제 그만... 원본 파일을 공유하니 필요하신 분은 개인적으로 수정해서 사용하시면 됩니다.`
...
# B737 KNEEBORARD 원본 파일

- ### [B737 KNEEBOARD 원본 파일](/img/flying/b737/Kneeboard.pptx) -> PPT 파일로 수정후 PDF로 내보내면 된다. 

## 원본 파일 수정법

![kneeboard](/img/flying/b737/737knee2.jpg)
- 원하는 내용 추가 및 수정법은 생략...
- 하이퍼 링크만 잘 편집해주면 바로가기로 편하게 사용할 수 있다. 

![kneeboard](/img/flying/b737/737knee1.jpg)
- 파일 - 내보내기 - PDF 를 선택해서 PDF로 내보내면 끝.

![kneeboard](/img/flying/b737/737knee3.jpg)
- 저장 옵션은 인쇄에 적합이면 충분함. 

> 이로써 B737의 KNEEBOARD의 업데이트를 종료한다. 

## `새로운 A330 KNEEBOARD는 이제 시작된다.`

- ## [A330 KNEEBOARD 바로가기](/posts/A330-kneeboard/)
...
# B737 최신 버전 다운로드
- ### [B737 KNEEBOARD 최신판(25.1.6)](/img/flying/b737/Kneeboard.pdf) -> 파일은 PDF파일로 개인적인 주석 및 필기로 필요사항을 첨부가 가능하다. 
...
- Revision Log
  - 25.1.6 : KMG 내용 추가
  - 24.12.18 : MFM 추가
  - 24.11.28 : KMG Comment 수정
  - 24.11.20 : TSN Comment 수정
  - 24.11.18 : FUK Comment 수정
  - 24.11.9 : TAO, HKG Commnet 수정, B737-900ER Deicing 절차 수정
  - 24.10.29 : HFE 수정, KMG 공항, FLAP 15 L/D 추가
  - 24.9.11 : HFE 추가, 특수공항 구분, PA 멘트 추가
