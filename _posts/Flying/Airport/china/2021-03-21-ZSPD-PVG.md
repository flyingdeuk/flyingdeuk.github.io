---
title: ZSPD(PVG) - 중국 상하이(푸동 공항) <2024.11.22 Updated>
date: 2021-03-21
categories: [Flying]
tags: [china, pvg]
pin:
...
- WIFI : Conference 선택후 암호로 접속이 가능함. 초기에 인터넷 연결없음이 뜨다가 조금 기다리면 연결됨. (시간이 소요됨)
  - 비행준비를 위한 인터넷 연결은 Flexiroam 셀룰러로 하거나 과거에 사용하던 F5 Access로 회사 서버에 연결하면 가능하다. (YOUTUBE, Netflix등도 볼 수는 있으나 추천되지는 않음)
      ![pvg](/img/flying/airport/f5.png) 
