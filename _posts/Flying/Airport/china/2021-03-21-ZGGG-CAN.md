---
title: ZGGG(CAN) - 중국 광저우(바이윈 공항) <2026.5.1 Updated>
date: 2021-03-21
categories: [Flying]
tags: [china, can]
pin:
...
- RNAV STAR를 사용함. 그래야 IAF와 연결이 가능함. 
...
- SZX 와 가까운 공항이나 상대적으로 덜 바쁜 공항임. 
- 통상은 20R 주나 19R 주는 경우도 있음. Gate 까지 TXY가 오래걸림. (브리핑 필요!!!)
...
## Walk Around 
- 로툰다에 있는 엘리베이터 또는 계단으로 1층으로 암호는 직원이 알려줌. 암호입력 V(check 표시) 누르고 엘리베이터 버튼 눌러야 문 열림
