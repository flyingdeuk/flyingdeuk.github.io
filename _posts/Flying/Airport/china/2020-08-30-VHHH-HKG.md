---
title: VHHH(HKG) - 중국 홍콩(홍콩 공항) <2024.11.9 Updated>
date: 2020-08-30
categories: [Flying]
tags: [china, hkg]
pin:
...
# Consideration
- 왕복비행시간이 7시간(BLOCK TIME 8시간)에 가까워. Deicing과 같은 딜레이 예상시 8시간 초과의 가능성이 있어 주의가 필요함. (R/O - R/I 시간 기준) 
- 접근과 이륙시 주변 Traffic의 관리를 속도 조절로 해서 속도제한 지키는 것이 중요함. 
...
> STAR APP Chart 상의 속도 제한과 다른 속도 지시시(Traffic 관련) 지시 속도 유지 관련 Confirm이 필요함. (10000ft 이하의 속도 역시 Confirm해야함. ICAO로 10000ft이하 속도 제한 AIP는 없으나 Chart상 TEXT로 있음.) => `MAX 250KT BELOW 10000 UNLESS OTHERWISE INSTRUCTED`


## APP
- 속도 조절을 통해서 Traffic 분리를 하며 전방기와 좁게 관제함. (속도 잘 지켜야함.)
...
- RWY 07R OCEAN Dep의 경우 PORPA 205-220KTS 제한으로 NADP 2하는 것이 205KTS 이상 유지하는데 도움이됨. 
- NADP 2 : ACCEL 1000ft, TH REDUCTION 1500ft 입력후 SPD Intervention 하지 않아도 잘 됨. (B737)
- 이륙후 Traffic 분리를 위해서 High SPD 지시하는 경우도 있음. 
