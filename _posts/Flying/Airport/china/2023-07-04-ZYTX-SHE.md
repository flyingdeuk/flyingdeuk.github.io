---
title: ZYTX(SHE) - 중국 선양(탸오쎈 공항) <2026.8.13 Updated>
date: 2023-07-04
categories: [Flying]
tags: [china, she]
pin:
...
`FlyingDeuk's`
> 공항 확장이후 코로나 이전과 비슷하나 최근 A-CDM 절차 적용이 좀더 세밀해진 느낌. DCL의 ADT(Approved Departure Time)이 TOBT, TSAT이 아니라 CTOT 개념으로 사용된다. 
...
## SID
- DCL 가능 기준 시간 -40분 전부터. Pushback 5분전에 Readback하라고 되어있음 (Jeppesen)
...
## GND
- Follow Me Car Service는 없었음. (요즘엔 OUTBD는 서비스 안하는 것 같음) 
