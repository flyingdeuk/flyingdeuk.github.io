---
title: ZLXY(XIY) - 중국 시안(시엔양 공항) <2025.7.24 Updated>
date: 2023-10-10
categories: [Flying]
tags: [china, xiy]
pin:
...
> 최근 활주로 추가 공사가 진행 중이고 Terminal이 변경됨. Terminal 5에 주기함. 

- 북쪽 활주로 RWY05L/23R로 착륙, 남쪽 활주로 RWY05R/23L로 이륙. 
...
- 주로 북쪽 활주로 배정됨, Parking Bay Terminal 5로 변경되어 TAXI시간이 오래걸림. 

## GND
- Hold Short Point에서 미리 Closing TWY xx라 Call하라고 Jeppesen에 되어있으나 Hold Short 이후 천천히 넘어가도 됨. -> 알아서 잘 주고 Closing이라는 표현보다는 Hold Short를 사용함. 
- Terminal 5로 이동후 Follow Me Car는 없는 듯
- Parking Bay E3, E4 두개의 Lane중 상황에 따라 줌. Solid Line은 다 연결되어 있음. 

-------

# DEPARTURE
## SID
- 10-30분전 DCL 요구 In Jeppesen Chart 통상 20분전이면 문안함. READBACK!!!
