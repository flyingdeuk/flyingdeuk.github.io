---
title: RJTT(HND) - 일본 도쿄(하네다 공항) <2026.9.13 Updated>
date: 2020-08-30
categories: [Flying]
tags: [japan, hnd]
pin:
...
- RWY 34L의 경우 Vacate이후 다음 지시에 빠르게 대처하는 것이 좋음. Traffic 간격이 좁은 경우 빨리 빼야 다음 Traffic이 Landing후 Vacate가 가능함. 
    - L12 - L/H Turn L - P11 
    - 특히 L13의 경우 더 복잡함
...
--------
# Immigraion
- INBD : 세관신고서 작성, Landing Permit 작성 및 이름에 Check 표시

# STAY
## [호텔 JAL 시티 하네다 도쿄](https://maps.app.goo.gl/74Yraus4i34MtC7r6) -> Click
- 공항 근처 호텔로 방이 정말 작다. 
- 칫솔, 면도기 등은 로비에서 가지고 올라가야함. 
- 1층에 환전 머신 있음. 
- 주변 편의점, 약국, 식당들이 많음(기차역 주변)

-----------

# Place
## [麺屋 銀星](https://maps.app.goo.gl/asY3rXF9DYo9sFMC9) -> Click
- 주변에서 평점 좋은 라면집 
- 니보시 라면 (해산물 베이스) 전문점 인듯
- 현금은 머신, 카드는 따로 점원에게 이야기하면 됨. 

## [Tsuruha Drug](https://maps.app.goo.gl/Mgg7m5C76KpX5UEZ6) -> Click
- 약국으로 되어있으나 슈퍼같은 느낌
