---
title: RJFF(FUK) - 일본 후쿠오카(후쿠오카 공항) <2024.11.18 Updated>
date: 2020-08-30
categories: [Flying]
tags: [japan, fuk]
pin:
...
- RWY 34시 Holding이 예상됨. 연료 추가 고려할 것. 
...
- 기상이 안좋으면 ILS 34를 사용하고 산악지형으로 TRK Mile이 길어짐. RNAV STAR HAWKS WEST가 예상됨. (추가로 날씨가 않좋으면 Holding이 주어짐.)
    - IKE Holding시 FMS DATA가 Chart와는 달라 Confirm이 필요함. Publish된 INBD CRS와 방향 1 min 의 확인이 필요함. (Hold over West of IKE라고는 이야기하나 Confirm이 필요함.)
...
- RWY 34 기상이 안좋으면 ILS 사용함. Holding이후 Vector로 STAR Join이후 APP CLR줌. 
...
- RWY 34의 경우 C9 Holding Point GP Hold Line 국제선에는 없음. (반대쪽 국내선에는 GP Hold Line이 있으며 ILS 사용시 Intersection으로 Hold Line이전으로 Line up 함.)
