---
title: RJCC(CTS) - 일본 삿포로(뉴 치토세 공항) <2025.11.8 Updated>
date: 2023-08-14
categories: [Flying]
tags: [japan, cts]
pin:
...
- 동쪽 활주로는 민항에서 서쪽 두개의 활주로는 군에서 사용함. 


# ENROUTE
![cts](/img/flying/airport/icncts.jpg)
- ICN - CTS : 2시간 20분, CTS - ICN : 2시간 30분 (JET STEAM에 따라 비행 시간이 많이 차이남. 30-40분, 특히 겨울철)
...
- NAVER, IDEMI 이후 RDR Vector와 속도 Control로 관제가 이루어짐. 
...
- 강설이후 RWY, TWY는 깨끗하게 제설작업이되나 Rapid Vacate TWY의 경우는 눈이 쌓여있는 경우가 많아서 주의가 필요함. (NOTAM에 Closed로 표시되는 경우도 있음)
