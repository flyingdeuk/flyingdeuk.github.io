---
title: RJBB(KIX) - 일본 오사카(간사이 공항) <2025.9.29 Updated>
date: 2020-08-30
categories: [Flying]
tags: [japan, kix]
pin:
...
`FlyingDeuk's`
>일본은 공항을 산이 아니면 인공섬에 많이 건설한다. 대표적인 인공섬 공항. 과거와는 다르게 Preferential RWY가 최근에 변경되었다. 
...
- 북쪽 RWY는 이륙으로 남쪽 RWY는 착륙으로 변경됨. 

# ENROUTE
![kix](/img/flying/airport/gmpkix.jpg)
- GMP - KIX : 1시간 20분, KIX - GMP : 1시간 30분
- ICN - KIX : 1시간 20분, KIX - ICN : 1시간 30분
...
- STAR 이름 변경되었으며 긴 STAR를 주로 주며 이후 RDR로 짧게 관제함. 


## APP
- Traffic에 따라 Short Cut 주며 속도 Restriction 도 같이 줌. 
- PWS False Warning에 대비해야함. 첫번째 GA이후 PWS 현상없으면 Continue.
...
- A330의 경우 V1 gate는 직각으로 Solid Line 따라 들어가면 됨. 
...
## GND
- 북쪽 RWY를 이륙으로 주로 사용하며 TAXI RTE 1, 2 주는 경우 있음. 
