---
title: VTBS(BKK) - 태국 방콕(수완나품 공항) <2024.7.8 Updated>
date: 2020-08-30
categories: [Flying]
...
- TV 뒷면의 HDMI 1에 연결후 메인 메뉴에서 Chrome Case(외부입력으로도 연결가능)라고 쓰여있는 아이콘을 누르면 FireTV로 연결됨. (LG TV)
- 유니폼 세탁을 위해서는 문에 걸어두고 전화, 다시 가져오라고 전화해야함. 직접 전달하는 방식인 듯.
- 호텔 마사지 프로모션으로 40불정도에 이용 가능하다고 하나 이용해 보지는 않음. 
