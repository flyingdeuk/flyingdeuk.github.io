...
## RWY 18L 이륙 36L 착륙 (LOW CEILING)
- Ceiling이 낮고 배풍이 10-15KTS 사이인 경우 이륙은 18으로 착륙은 36로 하는 경우도 있음. -> ARRIVAL ATIS에는 활주로 18으로 명시되어 있고 RWY 18 Below Landing Minima라고 명시되어 있고 최초 Contact시 Intension을 물어봄... (ATIS에 Dep 18 Arr 36라 쓰면 될 것을...)  
    - 위의 경우 이륙은 GIMHAE x DEP 사용함. 
    - 36L로 L/D후 36R로 TAXI DOWN ON THE RWY or BACK TRACK 지시함. 
    - 여러대를 18L로 이륙시키고 여러대를 36L로 L/D 시키는 방식으로 관제를 해서 Holding이 예상됨. 
...
![pus](/img/flying/airport/pus18.jpg)
    ...
    - FAF이후 MA Fix부터 RWY까지 Vref+5kts(Target SPD)다 넣어주는 것이 좋음. 
    - Descend Forecast에 1700ft 고도 바람 넣어주면 LNAV 끊어지는 것을 예방할 수 있는 것 같음. 

- VOR 18 주의사항
    - Ceiling이 낮은 경우 FAF 지나고 VS 1200-1300으로 미리 내려가는 편이 RWY Insight에 도움이됨. 
    - ALT HOLD 이후에 VNAV Engage하고 VNAV PTH 확인하고 Missed App ALT 6000ft SET하면됨. 
    - 가끔 VNAV 끊어지는 경우 다시 누르면 정상적으로 Engage됨. 
...
- 식사 쿠폰
    ...
    - 저녁 부페 2130, 베이커리 2200 까지 운영
    - 가끔 와인 행사하는 경우 쿠폰으로도 구매가 가능함. 
...
## [마라는사랑입니다 온천장점](https://naver.me/5DjtsDjM)(Click)
- 호텔에서 가까운 마라탕 집. 6000원이상 선택, 옥수수면은 알아서 양을 고르는게 아니고 이야기해야주며 고수는 2000원으로 이야기하면 따로 줌. 맛은 괜찮은 편임. 한국 사장님이 요리해줌. 

## [호호사직 닭발](https://naver.me/5jAnwzcz)(Click)
- 호텔에서 가까운 닭발 맛집. 2300가 Last Order임. 포장해서 먹어도 맛있음. 배민 포장 및 배달 가능함. 

## [경보관](https://naver.me/5Gy10zU1)(Click)
- 호텔에서 가까운 24시간 중국집. 포장 및 배달 가능. 

## [당미옥 한우곰탕 온천본점](https://naver.me/FCbVESW6)(Click)
- 24시간 곰탕집. 부산식 섞어 스타일 맛 볼수 있는 곰탕집. 맛은 그냥 평범한 듯. 김치가 맛있음. 
