...
- RWY24 : Vacate Point를 알려줌. 안되면 보고. 
...
# STAY
## Immigration
- INBD : 검역 세관신고서 QR Code 마지막 제시, 직원이 GD가 붙어있는 Info를 줌. (OUTBD시 필요함.)
- OUTBD : Crew Line으로 진입해 여권검사 짐검사 (도착시 반은 GD제출)
