---
title: VTBS(BKK) - 태국 방콕(수완나품 공항) <2025.4.6 Updated>
date: 2020-08-30
categories: [Flying]
...
- 라운지 변경!!, 1700-1900 1층에서 간단한 음식과 주류 가능함.
- 아침 가격 변경 할인후 400바트 
- Wifi 암호없이 연결
- Room Service 및 Mini Bar 정보는 QR로 검색가능
- TV 뒷면의 HDMI 1에 연결후 메인 메뉴에서 Chrome Cast(외부입력으로도 연결가능)라고 쓰여있는 아이콘을 누르면 FireTV로 연결됨. (LG TV)
  ![bkk](/img/flying/airport/bkkinfo.jpg)

- 유니폼 세탁을 위해서는 문에 걸어두고 전화, 다시 가져오라고 전화해야함. 직접 전달하는 방식인 듯.
