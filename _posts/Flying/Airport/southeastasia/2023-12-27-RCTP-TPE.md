---
title: RCTP(TPE) - 타이완 (타이페이 타오유엔 공항) <2025.8.5 Updated>
date: 2023-12-27
categories: [Flying]
tags: [southeast, tpe]
pin:
...
# Preflight
- NOTAM에 항상 홍콩과 유사하게 RWY Closed에 대해 명시되어 있다. (기타 특이사항없음)
    - 최근 Vacate Point에 대한 NOTAM이 있음. 
...
- PUS - TPE : 2시간 10분 정도, TPE - PUS : 1시간 40분 정도                  

- ICN-TPE : 2시간 +, TPE-ICN : 2시간 + (A330)
...
- STAR 종류가 단순한 공항
- SPD Restriction Jeppesen에 있음 (FL250-130는 at 280kts, 13000-10000 까지는 Max 280kts로 조금은 다름)
    - DES SPD 280kts하면 됨. 
...
![tpe](/img/flying/airport/tpevdgs.jpg)
    - Advanced Visual Docking Guidance System으로 녹색 Center Line을 기준으로 빨간 라인하나는 Little, 두개는 Much Deviation을 의미하며 벗어난 방향은 RED ARROW로 표시되며 남은 거리는 맨 좌측 끝의 화살표는 진행 정도를 표시한다. 
